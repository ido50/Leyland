...
not generated dynamically. These are mostly CSS and JavaScript files,
plus images and pictures.

How to server static files from your application depends on the way you
...
C<plackup>, the easiest way to serve static files would be to let the
...
In C<builder>, we enable L<Plack::Middleware::Static>, and tell it serve
...
When deploying your application, however, it is likely that you will run
