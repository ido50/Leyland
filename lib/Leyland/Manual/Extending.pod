...
Leyland also allows classes that extend Leyland::Context to define a method
...
such as logging modules or template engines, you are more than welcome
...
which describes how view classes should be created. Look at L<Leyland::View::Tenjin>
for an example.

If you want to go even further, since Leyland is entirely Moose based,
and if you're crazy enough, you can use Moose tricks and modifications to
