...
with no arguments. This will start the application under the "development"
Plack environment, listening on port 5000, so you'd be able to point
your web browser to L<http://localhost:5000/> and start testing your app.

=head1 DEPLOYING YOUR APPLICATION

When your application is ready for prime time, Plack's standalone web
serve is not a good choice for deployment. When that time comes, you'll
