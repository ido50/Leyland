...
=item 5. L<Leyland::Manual::Localization> - Describes how application
localization is performed.

=item 6. L<Leyland::Manual::Logging> - Describes how to use Leyland's
logging facilities.

=item 7. L<Leyland::Manual::Exceptions> - To err is human. To throw proper
HTTP exceptions divine.

=item 8. L<Leyland::Manual::Deployment> - Describes how to run/deploy/test
Leyland applications.
